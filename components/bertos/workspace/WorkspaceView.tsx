...
import {
  ...
  Diff, Eye, Save, PanelLeftOpen, PanelLeftClose
} from 'lucide-react'
...
export function WorkspaceView() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* File tree — hidden by default on mobile, toggle button in AI bar */}
      <div className={cn("flex-shrink-0 border-r border-zinc-800/50 flex flex-col w-52", !fileTreeVisible && "hidden md:flex")}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-shrink-0 px-4 py-3 border-b border-zinc-800/50 bg-zinc-950/50">
          <div className="flex items-center gap-2">
            {/* File tree toggle — mobile only */}
            <button
              onClick={() => setFileTreeVisible(v => !v)}
              className="md:hidden flex-shrink-0 p-1.5 rounded-lg border border-zinc-800 text-zinc-500 hover:text-zinc-300 hover:border-zinc-700 transition-all"
            >
              {fileTreeVisible
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="hidden md:flex w-72 flex-shrink-0 border-l border-zinc-800/50 flex-col">
