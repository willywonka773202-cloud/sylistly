...
export function CommandPalette() {
  ...
  const COMMANDS: Command[] = [
    ...
    },
    {
      ...
      description: 'Set Claude as primary model',
      icon: <Cpu className="w-4 h-4 text-violet-400" />,
      category: 'Model',
      keywords: ['claude', 'anthropic', 'model'],
      action: () => { setSelectedModel('claude'); setCommandPaletteOpen(false) },
    },
    {
      id: 'use-codex',
      label: 'Switch to Codex',
      description: 'Set Codex as primary model',
      icon: <Zap className="w-4 h-4 text-emerald-400" />,
      category: 'Model',
      keywords: ['codex', 'openai', 'model', 'code'],
      action: () => { setSelectedModel('codex'); setCommandPaletteOpen(false) },
    },
    {
      id: 'use-gemini',
      label: 'Switch to Gemini',
      description: 'Set Gemini as primary model',
      icon: <Globe className="w-4 h-4 text-blue-400" />,
      category: 'Model',
      keywords: ['gemini', 'google', 'model'],
      action: () => { setSelectedModel('gemini'); setCommandPaletteOpen(false) },
    },
    {
      id: 'use-auto',
