...
const GENERATED_POST_PLAN: Array<{
  ...
  { id: 'airport-neutral', title: 'Airport uniform', caption: 'A composed travel look with comfortable anchors and a sharp bag.', vibe: 'travel', label: 'Travel', frame: 'androgynous', budget: 'under250', seed: 102, tags: ['airport', 'neutral', 'travel'] },
  { id: 'street-femme-downtown', title: 'Downtown street edit', caption: 'Baggy shapes, black accessories, and a sneaker-first street formula.', vibe: 'streetwear', label: 'Streetwear', frame: 'fem', budget: 'under500', seed: 201, tags: ['streetwear', 'downtown', 'sneakers'] },
  { id: 'street-masc-campus', title: 'Campus layers', caption: 'A layered street fit that reads casual without losing intent.', vibe: 'streetwear', label: 'Streetwear', frame: 'masc', budget: 'under250', seed: 202, tags: ['streetwear', 'layers', 'casual'] },
  ...
  { id: 'edgy-masc-tech', title: 'Techwear utility', caption: 'Black utility pieces with technical shape and a crossbody finish.', vibe: 'techwear', label: 'Techwear', frame: 'masc', budget: 'under500', seed: 1002, tags: ['techwear', 'utility', 'black'] },
  { id: 'budget-campus-masc', title: 'Budget campus fit', caption: 'Affordable catalog staples built for class, coffee, and repeat wear.', vibe: 'campus', label: 'Campus', frame: 'masc', budget: 'under100', seed: 1101, tags: ['campus', 'budget', 'college'] },
  { id: 'budget-clean-fem', title: 'Under $150 clean edit', caption: 'A low-cost clean formula with real product anchors and no filler.', vibe: 'clean', label: 'Clean', frame: 'fem', budget: 'under100', seed: 1102, tags: ['budget', 'clean', 'under 150'] },
  { id: 'work-travel-masc', title: 'Work trip capsule', caption: 'A travel-ready outfit that can land directly in a casual office.', vibe: 'work', label: 'Work', frame: 'masc', budget: 'under500', seed: 1201, tags: ['work', 'travel', 'airport', 'office'] },
  { id: 'work-travel-fem', title: 'Travel workday set', caption: 'Comfortable enough for transit, polished enough for the first meeting.', vibe: 'work', label: 'Work', frame: 'fem', budget: 'under500', seed: 1202, tags: ['work', 'travel', 'office'] },
  { id: 'campus-clean-fem', title: 'Campus clean girl', caption: 'Soft campus pieces with a practical bag and sneaker base.', vibe: 'campus', label: 'Campus', frame: 'fem', budget: 'under250', seed: 1301, tags: ['campus', 'clean girl', 'college'] },
  { id: 'campus-street-masc', title: 'Class to dinner layers', caption: 'Street-leaning campus layers that still feel styled after class.', vibe: 'campus', label: 'Campus', frame: 'masc', budget: 'under250', seed: 1302, tags: ['campus', 'streetwear', 'class'] },
  { id: 'travel-neutral-all', title: 'Neutral airport stack', caption: 'Comfort, carry capacity, and clean layering for a real travel day.', vibe: 'travel', label: 'Travel', frame: 'androgynous', budget: 'under250', seed: 1401, tags: ['travel', 'airport', 'neutral'] },
  { id: 'travel-resort-fem', title: 'Vacation dinner pack', caption: 'Warm-weather polish with breathable pieces and vacation accessories.', vibe: 'vacation', label: 'Vacation', frame: 'fem', budget: 'under500', seed: 1402, tags: ['travel', 'vacation', 'resort'] },
  { id: 'old-money-budget-masc', title: 'Old money under budget', caption: 'Classic proportions without relying on luxury-only picks.', vibe: 'old-money', label: 'Old Money', frame: 'masc', budget: 'under250', seed: 1501, tags: ['old money', 'budget', 'preppy'] },
  { id: 'old-money-soft-fem', title: 'Soft old money edit', caption: 'A polished feminine take on classic layers, refined shoes, and a structured carry.', vibe: 'old-money', label: 'Old Money', frame: 'fem', budget: 'under500', seed: 1502, tags: ['old money', 'quiet luxury', 'preppy'] },
