...
export const BRAND_CATALOG_PRODUCTS: Product[] = [
  ...
  product({
    ...
    currency: 'USD',
    retailer: 'Uniqlo',
    retailerUrl: 'https://www.uniqlo.com/us/en/search/?q=airism%20oversized%20tee',
    imageUrl: catalogImage('#f4f5f7', 'AIRism Tee', 'UNIQLO'),
  ...
  product({
    ...
    currency: 'USD',
    retailer: 'Aritzia',
    retailerUrl: 'https://www.aritzia.com/us/en/search?q=effortless%20pant',
    imageUrl: catalogImage('#d8c4a7', 'Effortless', 'ARITZIA'),
  ...
  product({
    ...
    currency: 'USD',
    retailer: 'Nike',
    retailerUrl: 'https://www.nike.com/w?q=air%20force%201',
    imageUrl: catalogImage('#8df77f', 'Air Force 1', 'NIKE'),
  ...
  product({
    ...
    retailerUrl: 'https://www.stevemadden.com/search?q=slingback%20heel',
    imageUrl: catalogImage('#f0a6b5', 'Slingback', 'MADDEN'),
  ...
  product({
    ...
    currency: 'USD',
    retailer: 'Longchamp',
    retailerUrl: 'https://www.longchamp.com/us/en/search?text=le%20pliage',
    imageUrl: catalogImage('#6ecbd4', 'Le Pliage', 'LONGCHAMP'),
