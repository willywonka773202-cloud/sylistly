...
export const BRAND_CATALOG_PRODUCTS: Product[] = [
  ...
  product({
    ...
    currency: 'USD',
    retailer: 'COS',
    retailerUrl: 'https://www.cos.com/en_usd/search-results.html?q=t-shirt',
    imageUrl: catalogImage('#d9ddd8', 'Boxy Tee', 'COS'),
    metadata: { colors: ['white', 'black', 'stone'], styles: ['tee'], vibes: ['clean', 'minimal'], keywords: ['boxy tee', 'everyday basic'] },
  }),
  product({
    id: 'catalog-top-reformation-devon-knit',
    category: 'top',
    brand: 'Reformation',
    name: 'Devon Knit Top',
    priceCents: 9800,
    ...
    retailerUrl: 'https://www.thereformation.com/search?q=knit%20top',
    imageUrl: catalogImage('#f2c6bf', 'Knit Top', 'REFORM'),
    metadata: { colors: ['cream', 'black', 'pink'], styles: ['knit'], vibes: ['date', 'clean'], keywords: ['fitted knit', 'soft top'] },
  }),
  product({
    id: 'catalog-top-everlane-oxford',
    category: 'top',
    brand: 'Everlane',
    ...
    currency: 'USD',
    retailer: 'Everlane',
    retailerUrl: 'https://www.everlane.com/search?q=oxford%20shirt',
    imageUrl: catalogImage('#cad7ee', 'Oxford', 'EVERLANE'),
    metadata: { colors: ['blue', 'white'], styles: ['shirt'], vibes: ['office', 'preppy'], keywords: ['button down', 'oxford shirt'] },
  }),
  product({
    id: 'catalog-bottom-cos-wideleg-trouser',
    category: 'bottom',
    brand: 'COS',
    ...
    currency: 'USD',
    retailer: 'COS',
    retailerUrl: 'https://www.cos.com/en_usd/search-results.html?q=wide%20leg%20trousers',
    imageUrl: catalogImage('#d6cfca', 'Wide Trouser', 'COS'),
    metadata: { colors: ['charcoal', 'black', 'stone'], styles: ['trousers'], vibes: ['office', 'clean'], keywords: ['wide leg pants', 'tailored'] },
  }),
  product({
    id: 'catalog-bottom-reformation-cary-jean',
    category: 'bottom',
    brand: 'Reformation',
    name: 'Cary High Rise Slouchy Jeans',
    priceCents: 16800,
    currency: 'USD',
    retailer: 'Reformation',
    retailerUrl: 'https://www.thereformation.com/search?q=jeans',
    imageUrl: catalogImage('#8ba9d9', 'Slouchy Jean', 'REFORM'),
    metadata: { colors: ['blue'], styles: ['jeans'], vibes: ['streetwear', 'clean'], keywords: ['relaxed denim', 'high rise'] },
  }),
  product({
    id: 'catalog-bottom-uniqlo-pleated-wide',
    category: 'bottom',
    brand: 'Uniqlo',
    ...
    currency: 'USD',
    retailer: 'Uniqlo',
    retailerUrl: 'https://www.uniqlo.com/us/en/search?q=wide%20pants',
    imageUrl: catalogImage('#e3dccf', 'Pleated Pant', 'UNIQLO'),
    metadata: { colors: ['beige', 'black', 'olive'], styles: ['trousers'], vibes: ['clean', 'office'], keywords: ['pleated pants', 'wide pants'], featured: true },
  }),
  product({
    id: 'catalog-outer-cos-wool-blazer',
    category: 'outer',
    brand: 'COS',
    ...
    currency: 'USD',
    retailer: 'COS',
    retailerUrl: 'https://www.cos.com/en_usd/search-results.html?q=blazer',
    imageUrl: catalogImage('#7d6c73', 'Wool Blazer', 'COS'),
    metadata: { colors: ['brown', 'charcoal'], styles: ['blazer'], vibes: ['office', 'date'], keywords: ['tailored jacket', 'wool blazer'] },
  }),
  product({
    id: 'catalog-outer-mango-leather-bomber',
    category: 'outer',
    brand: 'Mango',
    ...
    currency: 'USD',
    retailer: 'Mango',
    retailerUrl: 'https://shop.mango.com/us/search?q=bomber%20jacket',
    imageUrl: catalogImage('#5f544e', 'Bomber', 'MANGO'),
    metadata: { colors: ['black', 'brown'], styles: ['bomber'], vibes: ['edgy', 'streetwear'], keywords: ['leather bomber', 'cropped jacket'] },
  }),
  product({
    id: 'catalog-outer-uniqlo-u-overcoat',
    category: 'outer',
    brand: 'Uniqlo U',
    ...
    currency: 'USD',
    retailer: 'Uniqlo',
    retailerUrl: 'https://www.uniqlo.com/us/en/search?q=coat',
    imageUrl: catalogImage('#bda98d', 'Overcoat', 'UNIQLO U'),
    metadata: { colors: ['camel', 'black'], styles: ['coat'], vibes: ['clean', 'office'], keywords: ['overcoat', 'long coat'] },
  }),
  product({
    id: 'catalog-shoes-adidas-samba',
    category: 'shoes',
    ...
    retailer: 'Adidas',
    retailerUrl: 'https://www.adidas.com/us/search?q=samba',
    imageUrl: catalogImage('#e9d7b6', 'Samba', 'ADIDAS'),
    metadata: { colors: ['white', 'black', 'gum'], styles: ['sneakers'], vibes: ['streetwear', 'clean'], keywords: ['samba', 'gum sole'], featured: true },
  }),
  product({
    id: 'catalog-shoes-loefflerrandall-heel',
    category: 'shoes',
    brand: 'Loeffler Randall',
    name: 'Camellia Pleated Heel',
    priceCents: 35000,
    currency: 'USD',
    retailer: 'Loeffler Randall',
    retailerUrl: 'https://loefflerrandall.com/search?q=heel',
    imageUrl: catalogImage('#e6b1a8', 'Pleated Heel', 'LR'),
    metadata: { colors: ['cream', 'black', 'burgundy'], styles: ['heels'], vibes: ['date', 'dressy'], keywords: ['heel', 'party shoe'] },
  }),
  product({
    id: 'catalog-shoes-clarks-wallabee',
    category: 'shoes',
    brand: 'Clarks',
    name: 'Wallabee Shoe',
    priceCents: 15000,
    currency: 'USD',
    retailer: 'Clarks',
    retailerUrl: 'https://www.clarks.com/en-us/search?q=wallabee',
    imageUrl: catalogImage('#b58a62', 'Wallabee', 'CLARKS'),
    metadata: { colors: ['maple', 'black'], styles: ['casual shoes'], vibes: ['cozy', 'streetwear'], keywords: ['moccasin', 'casual shoe'] },
  }),
  product({
    id: 'catalog-bag-polene-numero-dix',
    category: 'bag',
    brand: 'Polene',
    name: 'Numero Dix Bag',
    priceCents: 53000,
    currency: 'USD',
    retailer: 'Polene',
    retailerUrl: 'https://eng.polene-paris.com/search?q=numero%20dix',
    imageUrl: catalogImage('#9f7767', 'Numero Dix', 'POLENE'),
    metadata: { colors: ['tan', 'black'], styles: ['shoulder bag'], vibes: ['clean', 'date'], keywords: ['shoulder bag', 'curved bag'] },
  }),
  product({
    id: 'catalog-bag-baggu-nylon-shoulder',
    category: 'bag',
    brand: 'Baggu',
    ...
    currency: 'USD',
    retailer: 'Baggu',
    retailerUrl: 'https://www.baggu.com/search?q=medium%20crescent',
    imageUrl: catalogImage('#9cb6b8', 'Crescent Bag', 'BAGGU'),
    metadata: { colors: ['black', 'brown', 'green'], styles: ['shoulder bag'], vibes: ['streetwear', 'casual'], keywords: ['nylon bag', 'crescent bag'] },
  }),
  product({
    id: 'catalog-bag-demellier-vancouver',
    category: 'bag',
    brand: 'DeMellier',
    name: 'The Vancouver',
    priceCents: 47500,
    currency: 'USD',
    retailer: 'DeMellier',
    retailerUrl: 'https://demellierlondon.com/search?q=vancouver',
    imageUrl: catalogImage('#d4c0aa', 'Vancouver', 'DEMELLIER'),
    metadata: { colors: ['taupe', 'black'], styles: ['top handle'], vibes: ['office', 'luxury'], keywords: ['structured bag', 'top handle'] },
  }),
  product({
    id: 'catalog-top-skims-fits-everybody',
    category: 'top',
    brand: 'SKIMS',
    ...
    currency: 'USD',
    retailer: 'SKIMS',
    retailerUrl: 'https://skims.com/search?q=t-shirt',
    imageUrl: catalogImage('#dcc4b5', 'Fits Tee', 'SKIMS'),
    metadata: { colors: ['sand', 'black', 'white'], styles: ['tee'], vibes: ['clean', 'date'], keywords: ['fitted tee', 'soft basics'] },
  }),
  product({
    id: 'catalog-top-arket-knit-polo',
    category: 'top',
    brand: 'ARKET',
    ...
    currency: 'USD',
    retailer: 'ARKET',
    retailerUrl: 'https://www.arket.com/en_usd/search-result.html?q=polo',
    imageUrl: catalogImage('#c7d2cf', 'Knit Polo', 'ARKET'),
    metadata: { colors: ['cream', 'navy', 'green'], styles: ['polo'], vibes: ['preppy', 'clean'], keywords: ['knit polo', 'smart casual'] },
  }),
  product({
    id: 'catalog-bottom-mango-column-skirt',
    category: 'bottom',
    brand: 'Mango',
    ...
    currency: 'USD',
    retailer: 'Mango',
    retailerUrl: 'https://shop.mango.com/us/search?q=skirt',
    imageUrl: catalogImage('#8f7f7a', 'Midi Skirt', 'MANGO'),
    metadata: { colors: ['black', 'stone'], styles: ['skirt'], vibes: ['date', 'office'], keywords: ['column skirt', 'midi skirt'] },
  }),
  product({
    id: 'catalog-bottom-citizens-annelina',
    category: 'bottom',
    brand: 'Citizens of Humanity',
    name: 'Annina Wide Leg Jean',
    priceCents: 23800,
    currency: 'USD',
    retailer: 'Citizens of Humanity',
    retailerUrl: 'https://citizensofhumanity.com/search?q=annina',
    imageUrl: catalogImage('#8eabd6', 'Annina', 'CITIZENS'),
    metadata: { colors: ['indigo', 'light wash'], styles: ['jeans'], vibes: ['clean', 'streetwear'], keywords: ['wide leg jean', 'premium denim'] },
  }),
  product({
    id: 'catalog-outer-everlane-rain-mac',
    category: 'outer',
    brand: 'Everlane',
    ...
    currency: 'USD',
    retailer: 'Everlane',
    retailerUrl: 'https://www.everlane.com/search?q=trench',
    imageUrl: catalogImage('#c6b199', 'Modern Trench', 'EVERLANE'),
    metadata: { colors: ['tan', 'khaki'], styles: ['trench'], vibes: ['office', 'vacation'], keywords: ['trench coat', 'rain mac'] },
  }),
  product({
    id: 'catalog-outer-aimelion-tweed-jacket',
    category: 'outer',
    brand: "Aimé Leon Dore",
    name: 'Tweed Overshirt Jacket',
    priceCents: 32500,
    currency: 'USD',
    retailer: 'Aimé Leon Dore',
    retailerUrl: 'https://www.aimeleondore.com/search?q=jacket',
    imageUrl: catalogImage('#85745f', 'Tweed Jacket', 'ALD'),
    metadata: { colors: ['brown', 'olive'], styles: ['jacket'], vibes: ['streetwear', 'preppy'], keywords: ['overshirt', 'tweed jacket'] },
  }),
  product({
    id: 'catalog-shoes-ganni-buckle-ballerina',
    category: 'shoes',
    brand: 'GANNI',
    name: 'Buckle Ballerina Flats',
    priceCents: 39500,
    currency: 'USD',
    retailer: 'GANNI',
    retailerUrl: 'https://www.ganni.com/us/search?q=ballerina',
    imageUrl: catalogImage('#d2b0a0', 'Ballerina', 'GANNI'),
    metadata: { colors: ['black', 'silver'], styles: ['flats'], vibes: ['date', 'edgy'], keywords: ['buckle flats', 'ballerina flats'] },
  }),
  product({
    id: 'catalog-shoes-newbalance-9060',
    category: 'shoes',
    brand: 'New Balance',
    name: '9060 Sneaker',
    priceCents: 15000,
    currency: 'USD',
    retailer: 'New Balance',
    retailerUrl: 'https://www.newbalance.com/search?q=9060',
    imageUrl: catalogImage('#c9c9cf', '9060', 'NB'),
    metadata: { colors: ['grey', 'cream'], styles: ['sneakers'], vibes: ['streetwear', 'gym'], keywords: ['dad sneaker', 'chunky sneaker'] },
  }),
  product({
    id: 'catalog-bag-apc-grace',
    category: 'bag',
    brand: 'A.P.C.',
    name: 'Grace Small Bag',
    priceCents: 69500,
    currency: 'USD',
    retailer: 'A.P.C.',
    retailerUrl: 'https://www.apc-us.com/search?q=grace',
    imageUrl: catalogImage('#7f5f56', 'Grace Bag', 'APC'),
    metadata: { colors: ['burgundy', 'black'], styles: ['shoulder bag'], vibes: ['clean', 'date'], keywords: ['structured shoulder bag', 'leather bag'] },
  }),
  product({
    id: 'catalog-eyewear-gentlemonster-musee',
    category: 'eyewear',
    brand: 'Gentle Monster',
    name: 'Musee Sunglasses',
    priceCents: 32000,
    currency: 'USD',
    retailer: 'Gentle Monster',
    retailerUrl: 'https://www.gentlemonster.com/us/search?q=sunglasses',
    imageUrl: catalogImage('#c0b8b6', 'Musee', 'GM'),
    metadata: { colors: ['black', 'brown'], styles: ['sunglasses'], vibes: ['edgy', 'clean'], keywords: ['oval sunglasses', 'statement eyewear'] },
  }),
  product({
    id: 'catalog-jewelry-monica-vinader-chain',
    category: 'jewelry',
    brand: 'Monica Vinader',
    name: 'Paperclip Chain Necklace',
    priceCents: 17800,
    currency: 'USD',
    retailer: 'Monica Vinader',
    retailerUrl: 'https://www.monicavinader.com/us/search?q=chain',
    imageUrl: catalogImage('#e4c685', 'Paperclip', 'VINADER'),
    metadata: { colors: ['gold'], styles: ['necklace'], vibes: ['clean', 'office'], keywords: ['paperclip chain', 'layering necklace'] },
  }),
];
...
export function searchBrandCatalog(
  ...
  const pool = BRAND_CATALOG_PRODUCTS
